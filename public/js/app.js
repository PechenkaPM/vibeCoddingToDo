...
document.querySelectorAll(".todo-item").forEach((item) => {
  ...
  captureThenSubmit(item.querySelector('form[action$="/toggle"]'),
    isComplete ? "task_reopened" : "task_completed", () => ({ title }));
  captureThenSubmit(item.querySelector('form[action$="/delete"]'),
    "task_deleted", () => ({ title }));
});
